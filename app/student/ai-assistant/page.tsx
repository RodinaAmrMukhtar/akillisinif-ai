...
const exampleQuestions = [
  ...
  "Eksik ödevim var mı?",
  "Not durumumu analiz et.",
  "Yoklama durumum nasıl?",
];
...
export default function StudentAiAssistantPage() {
  ...
  const [messages, setMessages] = useState<ChatMessage[]>([
    {
      role: "assistant",
      content:
        "Merhaba. Ben AkıllıSınıf AI öğrenci akademik asistanıyım. Not, ödev ve yoklama verilerinize göre kişisel öneriler sunabilirim.",
    },
  ]);
  ...
  return (
    <DashboardShell
      title="AI Asistan"
      description="Gerçek not, ödev ve yoklama verilerine dayalı öğrenci akademik destek asistanı."
          ...
          <div className="flex flex-col gap-5 lg:flex-row lg:items-start lg:justify-between">
            <div>
              <p className="flex items-center gap-2 text-sm font-semibold text-blue-700">
                <BsRobot />
                Kişisel Akademik Destek Modu
              </p>
              <h2 className="mt-3 text-3xl font-bold tracking-tight text-blue-950">
                Öğrenci gelişim asistanı
              </h2>
              <p className="mt-3 max-w-3xl text-sm leading-7 text-blue-900">
                Bu asistan notlarınızı, ödev teslimlerinizi ve yoklama durumunuzu
                analiz ederek gelişim önerileri sunar.
              </p>
            </div>
            ...
            <div className="grid gap-3 sm:grid-cols-3 lg:min-w-[420px]">
              <div className="rounded-2xl bg-white p-4">
                ...
                <p className="mt-3 text-sm font-bold text-slate-950">Notlar</p>
              </div>

              <div className="rounded-2xl bg-white p-4">
                <BsCardChecklist className="text-blue-700" />
                <p className="mt-3 text-sm font-bold text-slate-950">Ödevler</p>
              </div>
        ...
        <section className="grid gap-5 lg:grid-cols-[1fr_320px]">
          <div className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
            ...
            <form onSubmit={handleSubmit} className="mt-6 flex flex-col gap-3">
              <textarea
                ...
                rows={3}
                placeholder="Örnek: Neyi geliştirmeliyim?"
          ...
          <aside className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
            ...
            <p className="mt-2 text-sm leading-6 text-slate-600">
              Kişisel akademik öneri almak için bir soru seçebilirsiniz.
            </p>
