...
<img src="https://img.shields.io/badge/🎓_AkıllıSınıf_AI-Yapay_Zekâ_Destekli_Eğitim_Platformu-6366f1?style=for-the-badge&labelColor=1e1b4b" alt="AkıllıSınıf AI" width="600"/>
...
[![Make](https://img.shields.io/badge/Make.com-6D00CC?style=for-the-badge&logo=make&logoColor=white)](https://make.com/)
[![OpenRouter](https://img.shields.io/badge/OpenRouter_AI-FF6B35?style=for-the-badge&logo=openai&logoColor=white)](https://openrouter.ai/)
...
[![Outlook](https://img.shields.io/badge/Outlook-0078D4?style=for-the-badge&logo=microsoftoutlook&logoColor=white)](https://outlook.com/)

<br/>

[![License: MIT](https://img.shields.io/badge/Lisans-MIT-yellow.svg?style=flat-square)](https://opensource.org/licenses/MIT)
[![Made with Love](https://img.shields.io/badge/Made_with-❤️-red?style=flat-square)]()
[![Status](https://img.shields.io/badge/Durum-🟢_Canlı-brightgreen?style=flat-square)]()
[![Automations](https://img.shields.io/badge/Otomasyon-13_Workflow-6D00CC?style=flat-square)]()
[![AI Powered](https://img.shields.io/badge/AI-Destekli-FF6B35?style=flat-square&logo=openai)]()
...
### 🏠 Ana Sayfa
![Ana Sayfa](screenshots/vercel1.JPG)
...
### ⚡ Özellikler
![Özellikler](screenshots/vercel2.JPG)
...
### 📊 Öğretmen Paneli
![Öğretmen Paneli](screenshots/vercel5.JPG)
*Aktif sınıf · Toplam öğrenci · Onay bekleyen · Riskli öğrenci istatistikleri*

</td>
<td width="50%">

### 🏷️ Sınıf Detayı & Davet Kodu
![Sınıf Detay](screenshots/vercel6.JPG)
...
### 📡 QR Kod ile Yoklama
![Yoklama](screenshots/vercel7.JPG)
...
![AI Asistan](screenshots/vercel8.JPG)
...
- ⚠️ **AI Risk Analizi** — Yüksek / orta / düşük risk sınıflandırması
...
|--------|-----------|----------|
| 🖥️ **Frontend** | Next.js + React | Vercel üzerinde deploy edilmiş |
| 🔐 **Kimlik Doğrulama** | Supabase Auth | E-posta/şifre, rol tabanlı oturumlar |
| 🗄️ **Veritabanı** | Airtable | `AkilliSinif_AI_Veritabani` ilişkisel tabanı |
| ⚙️ **Otomasyon** | Make.com | 13 zamanlanmış & webhook tetiklemeli workflow |
| 🤖 **Yapay Zekâ** | OpenRouter API | GPT-4 / Claude modelleri |
| 📁 **Dosya Depolama** | Google Drive | Make.com üzerinden ödev arşivi |
| 📧 **E-posta** | Microsoft Outlook | Make.com entegrasyonu |
...
### Airtable Ekran Görüntüleri

| Kullanıcılar Tablosu | Sınıflar Tablosu | Tahminler Tablosu |
|---|---|---|
| ![Kullanicilar](screenshots/air1.JPG) | ![Siniflar](screenshots/air2.JPG) | ![Tahminler](screenshots/air3.JPG) |
| *Auth_ID Supabase bağlantısı ile* | *Sınıf kayıtları, öğretmen ve dönem bilgisi* | *AI tahmin özetleri öğrenci bazında* |

---

## 🤖 Make.com Otomasyon Workflow'ları
...
![Workflow 01](screenshots/01.JPG)

Haftalık olarak tüm öğrenci verilerini (notlar, yoklama, teslimler, notlar) toplar, OpenRouter AI'a gönderir ve üretilen risk raporunu Airtable'a kaydeder. Öğretmenlere Outlook üzerinden özet gönderir.
...
![Workflow 02](screenshots/02.JPG)
...
![Workflow 03](screenshots/03.JPG)
...
![Workflow 04](screenshots/04.JPG)
...
![Workflow 05](screenshots/05.JPG)
...
![Workflow 06](screenshots/06.JPG)
...
![Workflow 07](screenshots/07.JPG)
...
![Workflow 08](screenshots/08.JPG)
...
![Workflow 09](screenshots/09.JPG)

Tüm Airtable tablolarının (kullanıcılar, sınıflar, üyelikler, ödevler, teslimler, notlar, yoklama, bildirimler, tahminler) tam denetimini yapar ve bir veri kalite raporu kaydeder.
...
![Workflow 10](screenshots/10.JPG)
...
![Workflow 11](screenshots/11.JPG)
...
![Workflow 12](screenshots/12.JPG)
...
![Workflow 13](screenshots/13.JPG)
...
## 📂 GitHub'da Görseller Nasıl Çalışır?

> **❓ Görselleri GitHub'a yüklemem gerekiyor mu?**

**Evet — kısa cevap bu.** README'deki tüm görseller (`screenshots/vercel1.JPG` gibi) **repo içindeki göreli yollara** bakıyor. GitHub'da görünmeleri için `screenshots/` klasörünü reponuzun köküne yüklemeniz gerekiyor.

**Yapmanız gereken:**
```
reponuz/
├── README.md          ← bu dosya
├── screenshots/       ← bu klasörü de yükleyin ✅
│   ├── vercel1.JPG
│   ├── vercel2.JPG
│   ├── ... (tüm görseller)
│   └── 13.JPG
...
Tek seferlik bir işlem ve GitHub önbelleğe aldığı için sayfa yüklemesini yavaşlatmaz.
...
- [Make.com](https://make.com/) hesabı (otomasyonlar için)
...
# Make.com Webhook (AI Asistan Workflow 11)
...
**Yapımcı:** AkıllıSınıf AI Ekibi &nbsp;·&nbsp; **Lisans:** MIT &nbsp;·&nbsp; **Durum:** 🟢 Canlı

[![Canlı Demo](https://img.shields.io/badge/🌐_Canlı_Demo-akillisinif--ai.vercel.app-6366f1?style=for-the-badge)](https://akillisinif-ai.vercel.app/)
